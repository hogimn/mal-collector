...
export const ListBox = styled.div`
    ...
    align-items: center;
    background-color: ${({category}) => category === "genre" ? "rgba(75, 74, 74, 0.22)" : "rgba(74, 92, 116, 0.22)"};
    padding: 3px;
    flex-wrap: wrap;
  
    span {
        background-color: ${({category}) => category === "genre" ? "rgba(122, 120, 120, 0.22)" : "rgba(151, 182, 218, 0.22)"};
        border-radius: 8px;
        padding: 1px 4px;
        margin: 2px;
        font-size: 0.6rem;
